...
(* CORE_GENERATION_INFO = "greyscale_algorithm,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=greyscale_algorithm,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=6,numReposBlks=6,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,synth_mode=Global}" *) (* HW_HANDOFF = "greyscale_algorithm.hwdef" *) 
module greyscale_algorithm
  ...
  assign M_AXIS_RESULT_0_tdata[31:0] = floating_point_5_M_AXIS_RESULT_TDATA;
  assign M_AXIS_RESULT_0_tvalid = floating_point_5_M_AXIS_RESULT_TVALID;
  ...
  assign floating_point_5_M_AXIS_RESULT_TREADY = M_AXIS_RESULT_0_tready;
