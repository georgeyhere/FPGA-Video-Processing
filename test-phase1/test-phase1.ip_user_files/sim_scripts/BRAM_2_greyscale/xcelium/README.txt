...
#
# Generated by export_simulation on Thu Jan 07 19:22:24 -0800 2021
#
################################################################################
...
'-reset_run' switch to the './BRAM_2_greyscale.sh' script.

./BRAM_2_greyscale.sh -reset_run
...
./BRAM_2_greyscale.sh -noclean_files

For more information on the script, please type './BRAM_2_greyscale.sh -help'.
