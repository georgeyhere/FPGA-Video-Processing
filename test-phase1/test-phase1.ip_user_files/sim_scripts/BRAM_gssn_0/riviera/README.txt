...
#
# Generated by export_simulation on Mon Jan 11 13:45:33 -0800 2021
#
################################################################################
...
'-reset_run' switch to the './BRAM_gssn_0.sh' script.

./BRAM_gssn_0.sh -reset_run
...
./BRAM_gssn_0.sh -noclean_files

For more information on the script, please type './BRAM_gssn_0.sh -help'.
