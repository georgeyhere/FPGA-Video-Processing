...
#
# Generated by export_simulation on Tue Jan 12 18:48:52 -0800 2021
#
################################################################################
...
'-reset_run' switch to the './BRAM_gssn_1.sh' script.

./BRAM_gssn_1.sh -reset_run
...
./BRAM_gssn_1.sh -noclean_files

For more information on the script, please type './BRAM_gssn_1.sh -help'.
