...
#
# Generated by export_simulation on Tue Jan 12 18:49:46 -0800 2021
#
################################################################################
...
'-reset_run' switch to the './BRAM_gssn_2.sh' script.

./BRAM_gssn_2.sh -reset_run
...
./BRAM_gssn_2.sh -noclean_files

For more information on the script, please type './BRAM_gssn_2.sh -help'.
