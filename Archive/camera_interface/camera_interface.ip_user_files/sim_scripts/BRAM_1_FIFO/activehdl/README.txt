...
#
# Generated by export_simulation on Fri Dec 25 14:31:50 -0800 2020
#
################################################################################
...
'-reset_run' switch to the './BRAM_1_FIFO.sh' script.

./BRAM_1_FIFO.sh -reset_run
...
./BRAM_1_FIFO.sh -noclean_files

For more information on the script, please type './BRAM_1_FIFO.sh -help'.
